 ...
 * @notice This contract is creating for simple raffle
...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    constructor(
        ...
        s_raffleState = RaffleState.OPEN; // initializes OPEN state
    }
     ...
     * 4. Implicitly, our subscription has LINK token
     * @param - ignored
        ...
        VRFV2PlusClient.RandomWordsRequest memory request = VRFV2PlusClient
            .RandomWordsRequest({
                ...
                extraArgs: VRFV2PlusClient._argsToBytes(
                    //set native payment to true to pay for VRF requests with ETH sepolia instead of LINK
    ...
    function fulfillRandomWords(
        ...
        s_lastTimeStamp = block.timestamp;
        emit WinnerPikced(s_recentWinner);
    ...
    function geLastTimeStamp() external view returns (uint256) {
